...
import org.yaswanth.jdbc.service.StudentListResultSetExtrator;
import org.yaswanth.jdbc.service.StudentResultSetExtrator;
...
public class StudentDAOImpl implements StudentDAO {
	...
	public List<Student> findAllStudents() {
		...
		List<Student> students = jdbcTemplate.query(sql, new StudentListResultSetExtrator());
	...
	public Student findStudentByRollNo(int rollNo) {
		...
		Student sutdent = jdbcTemplate.query(sqlStatement, new StudentResultSetExtrator(), rollNo);
